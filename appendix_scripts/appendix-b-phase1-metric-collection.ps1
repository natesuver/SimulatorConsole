#Appendix B: Powershell script used to gather metrics used for objective function
...
SUM(proc_stats.total_logical_reads),
...
CASE WHEN ran_on_peak = 1 THEN 1
     ...
     ELSE 0 END,
total_logical_reads= isnull(proc_stats.total_logical_reads,0),
...
INNER JOIN 
    ...
    SUM(raw_stats.total_logical_reads) as total_logical_reads,
...
#Sample Usage:
#. ./phase1-metric-collection.ps1 -servername "<your-server>" -databasename "<your-database>" -stat_tracking_db "performance" -peak_hour_start 7 -peak_hour_end 18 -polling_interval 5
