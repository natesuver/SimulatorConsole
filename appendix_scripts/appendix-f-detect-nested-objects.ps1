#Appendix F: Powershell script to detect nested SQL Objects
...
'@ -f $procedure_name
 ...
 #Sample Usage
 #. ./detect-nested-objects -servername "<your server>" -database "<your database>" -procedure_name "<your procedure name>"
